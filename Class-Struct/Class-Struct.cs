...
namespace Vsite.CSharp.DefiniranjeTipa
{
    ...
    class ClassStruct
    {
        public static void IspišiStrukture()
        {
            ...
            ms1.IspišiČlan();
            ms2.IspišiČlan();
            //Strukture se smještene na stogu i svaka je posebno mjesto u memoriji
        ...
        public static void IspišiKlase()
        {
            ...
            mk1.IspišiČlan();
            mk2.IspišiČlan();
            //Klase su smještene na heapu i pristupa im se preko referneci, u ovom slučaju obje reference pokazuju na isto mjesto u memoriji
        }
