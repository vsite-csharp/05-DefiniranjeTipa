...
namespace Vsite.CSharp.DefiniranjeTipa
{
    ...
    class DefinicijaTipa
    {
        public static void IspišiČlanKlase()
        {
            ...
            MojaKlasa ispisČlanaKlase = new MojaKlasa();
            ispisČlanaKlase.IspišiČlan();
        ...
        public static void IspišiČlanStrukture()
        {
            ...
            MojaStruktura ispisČlanaStrukture = new MojaStruktura("MojaStruktura");
            ispisČlanaStrukture.IspišiČlan();
        }
