...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class MojaKlasa
    {
        ...
        private int broj = 5; // I ako ne stavim private bila bi private
    ...
    struct MojaStruktura
    {
        ...
        private string tekst;// = "Moja struktura";
        // potreban je konstrukto 
    ...
    class DefinicijaTipa
    {
        public static void IspišiČlanKlase()
        {
            ...
            var mk = new MojaKlasa(); // instanca objekta 
            mk.IspišiČlan(); 
