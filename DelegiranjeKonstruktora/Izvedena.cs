...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class Izvedena : Bazna
    {
        ...
        // TODO:080 Dodati konstruktor s dva argumenta ("a" i "b") tipa int, kojima će se inicijalizirati članovi A i B. Konstruktor treba pozivati konstruktor bazne klase s jednim argumentom i proslijediti mu argument a.
       public Izvedena(int a,int b) : base(a)  //POZIVA SE KONSTRUKTOR BAZNE KLASE
        {
            B = b;
