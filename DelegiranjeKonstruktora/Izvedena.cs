...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class Izvedena  : Bazna
    {
        ...
        // kojima će se inicijalizirati članovi A i B.
        // Konstruktor treba pozivati konstruktor bazne klase s jednim argumentom i proslijediti mu argument a.
        public Izvedena (int a, int b) : base(a) // poziv bazičnog 
        {
            B = b;
        ...
        // :084 Dodati konstruktor s jednim argumentom "a" tipa int.
        // Taj konstruktor treba pozvati ("delegirati") prethodno definirani konstruktor 
