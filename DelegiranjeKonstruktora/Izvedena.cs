namespace Vsite.CSharp.DefiniranjeTipa
{
    class Izvedena:Bazna
    {
		...
		// :081 U tijelo konstruktora dodati naredbu za ispis: Console.WriteLine($"Izvedena.Izvedena(a: {a}, b: {b})");
		...
		// 085 U tijelo konstruktora dodati naredbu za ispis: Console.WriteLine($"Izvedena.Izvedena(a: {a})");
