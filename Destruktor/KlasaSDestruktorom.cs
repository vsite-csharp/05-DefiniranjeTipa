...
namespace Vsite.CSharp.DefiniranjeTipa
{
    public class KlasaSDestruktorom
    {
        ...
        // TODO:100 Dodati destruktor (tj. finalizirajuću metodu) i njemu napisati naredbe koje će u konzolu i u
        // Output prozor ispisati: "Destruktor objekta br. {RedniBroj}"
        ~KlasaSDestruktorom()
        {
