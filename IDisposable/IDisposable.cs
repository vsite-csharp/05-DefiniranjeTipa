...
namespace Vsite.CSharp.DefiniranjeTipa
{
    ...
    class RadSdatotekom : IDisposable
    {
        ...
        {
            sw = new StreamWriter(imeDatoteke); // implementira, kreira datoteku i zapisuje u nju, postoji i drži handle na datoteku
            // nismo u mogućnosti obrisati datoteku 
        }
        ...
        {
            // zadužena za oslobađanje resursa 
            if (!disposed)
            {
                sw.Close();
                disposed = true; 
