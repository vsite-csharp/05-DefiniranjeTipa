...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class Internal
    {
        ...
        public static void IspišiIzvedenuIzBazne()
        {
            ...
            // 033 Otkomentirajte donju naredbu, prevedite kod i provjerite radi li poziv ispravno.
            izvedenaIzBazne.IspišiMe();
        }

        public static void IspišiIzvedenuIzInterneBazne()
        {
            // 034 U klasi IzvedenaIzInterneBazne treba, bez promjene prava pristupa, omogućiti poziv metode IspišiMe iz klase InternaBazna ali bez promjene koda klase InternaBazna!
            IzvedenaIzInterneBazne izvedenaIzInterne = new IzvedenaIzInterneBazne();
            // 035 Otkomentirati donju naredbu i provjeriti izvođenje.
            izvedenaIzInterne.IspišiMe();
        }

        // 036 Pokrenuti testove i provjeriti prolaze li sva 3 testa u grupi TestInternal
    }
}
