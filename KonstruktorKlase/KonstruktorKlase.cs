namespace Vsite.CSharp.DefiniranjeTipa
{
    static class KonstruktorKlase
    {
        ...
        {
            // DONE:060 Stvoriti objekt klase Osoba i ispisati vrijednosti članova Ime, Prezime, DatumRođenja
            Osoba o = new Osoba();
        ...
        {
            // DONE:063 Stvoriti objekt klase Osoba pozivom tog konstruktora i ispisati vrijednosti članova Ime, Prezime, DatumRođenja
        ...
        // DONE:064 Pokrenuti testove i provjeriti prolazi li test u grupi TestKonstruktoraKlase
