...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class KorištenjeObjekata
    {
        ...
        {
            Console.WriteLine(DateTime.Now);  //DateTime je struktura (ima u sebi staticke clanove), .Now (ispisat ce se trenutno vrijeme)
        }
        ...
        {
            Console.WriteLine(DateTime.Now.ToShortDateString());  // ToShortDateString() prikazat ce samo datum 
        }
        ...
        {
            Console.WriteLine(DateTime.Now.ToShortTimeString()); //ToShortTimeString() prikazat ce samo vrijeme
        }
        ...
        public static int IzračunajBrojDanaIzmeđuDvaDatuma(int godina1, int mjesec1, int dan1, int godina2, int mjesec2, int dan2)
        {
            ...
            var datum2 = new DateTime(godina2, mjesec2, dan2);  //"alt strijelica" pomice redak
