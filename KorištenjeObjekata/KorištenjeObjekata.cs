...
namespace Vsite.CSharp.DefiniranjeTipa
{
    static class KorištenjeObjekata
    {
        ...
        {
            // 003 Stvoriti objekt "datum1" tipa DateTime tako da se njegovom konstruktoru
            // proslijede godina1, mjesec1 i dan1.
            var datum1 = new DateTime(godina1, mjesec1, dan1);
            // 004 Stvoriti objekt "datum2" tipa DateTime tako da se njegovom konstruktoru
            // proslijede godina2, mjesec2 i dan2.
            var datum2 = new DateTime(godina2, mjesec2, dan2);
            // 005 Izračunati razliku između datum1 i datum2 (jednostavnim oduzimanjem: datum2 - datum1) i
            // tu razliku dodijeliti varijabli "period" tipa TimeSpan (koja služi za pohranu vremenskog perioda).
            var period = datum2 - datum1;
            // 006 Budući da metoda mora kao rezultat vratiti izračunati period izražen kao broj dana,
            // iz prethodno izračunatog perioda treba dohvatiti i vratiti svojstvo Days (tj. svojstvo TimeSpan.Days).
            return period.Days;
        }
