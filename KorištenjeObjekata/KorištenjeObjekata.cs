...
namespace Vsite.CSharp.DefiniranjeTipa
{
    class KorištenjeObjekata
    {
        ...
        public static int IzračunajBrojDanaIzmeđuDvaDatuma(int godina1, int mjesec1, int dan1, int godina2, int mjesec2, int dan2)
        {
            ...
            // T005 Izračunati razliku između datum1 i datum2 (jednostavnim oduzimanjem: datum2 - datum1) i tu razliku dodijeliti varijabli "period" tipa TimeSpan (koja služi za pohranu vremenskog perioda).
            var raspon = datum2 - datum1;
